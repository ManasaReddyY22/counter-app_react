      ...
      >
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400 }}>Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-2" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>
                Password
              </label>
              <input
                id="password"
